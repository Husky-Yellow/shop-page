<template funcitonal>
    <main>
        <img class="width-auto" :src="showValue.img">
        <h2 class="h2">{{ showValue.title }}</h2>
        <ul>
            <li v-for="(item, index) in showValue.video" :key="index">
                <h3 class="h3">{{ item.subTitle }}</h3>
                <ul>
